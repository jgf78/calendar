...
public class CalendarController {
    ...
    @Operation(
        summary = "Test de conexión con Google Calendar",
        description = "Verifica que el servicio está funcionando correctamente"
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Servicio OK"),
    ...
    @Operation(
        ...
        description = "Devuelve todos los eventos agrupados por calendario para una fecha concreta"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, List<EventDto>>> getEventsByDate(
            ...
            @Parameter(
                description = "Fecha a consultar en formato ISO",
                example = "2026-04-23",
                required = true,
